...
from .views import (AuthToken, CustomUserViewSet, FollowViewSet,
                    IngredientViewSet, RecipesViewSet, TagViewSet,
                    set_password)
...
urlpatterns = [
    ...
    re_path(
        r"^auth/token/logout/?$", TokenDestroyView.as_view(), name="logout"
    ),
